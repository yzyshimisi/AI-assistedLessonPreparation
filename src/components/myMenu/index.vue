<template>
<div class="w-[10vw] bg-base-100 rounded-xl p-3 shadow-xl text-xl">
  ...
  <span class="flex justify-center mt-1 hover:bg-base-300 hover:cursor-pointer rounded-md p-1"><router-link to="/classAcademic">班级学业</router-link></span>
  <div style="border-bottom: 2px solid #000000;" class="mt-2"></div>
